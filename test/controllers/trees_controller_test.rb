...
class TreesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tree" do
    assert_difference("Tree.count") do
      post trees_url, params: { tree: { common_name: @tree.common_name, diameter: @tree.diameter, location: @tree.location } }
    end
  ...
  test "should update tree" do
    patch tree_url(@tree), params: { tree: { common_name: @tree.common_name, diameter: @tree.diameter, location: @tree.location } }
